...
const learnItems = [
    {
      ...
      desc: "Master enriched doughs, laminated doughs and professional mixing methods.",
    },
    {
      title: "Layer Cakes & Fillings",
      desc: "Learn multi-layer cake preparation with premium fillings and textures.",
    },
    {
      title: "Professional Pastries",
      desc: "Croissants, tarts, puff pastry and bakery-level desserts.",
    },
    {
      title: "Cake Decorating Skills",
      desc: "Advanced piping, fondant work and creative cake designs.",
    },
    {
      title: "Chocolate & Confectionery",
      desc: "Tempering chocolate and making truffles, pralines and desserts.",
    },
    {
      title: "Client-Based Projects",
      desc: "Work on real bakery orders and presentation-based assignments.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div>
            ...
            <p className="text-lg text-[#666] leading-8 mb-8 max-w-xl">
              ...
              Builds on basics with layered cakes, advanced fillings, intermediate bread techniques and decorative finishing.
...
I want to enroll in Moderate Baking Course.

Course: Moderate Baking Course
Duration:3 months
Level: Intermediate
