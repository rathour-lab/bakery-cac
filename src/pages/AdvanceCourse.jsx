...
function AdvancedCourse() {
 ...
 const learnItems = [
    {
      title: "Master Bakery Techniques",
      desc: "Professional-level baking including artisan breads and advanced fermentation methods.",
    },
    {
      title: "Wedding & Celebration Cakes",
      desc: "Multi-tier cake structuring, stability, and luxury decoration skills.",
    },
    {
      title: "French Pastry Mastery",
      desc: "Macarons, éclairs, mille-feuille and high-end patisserie techniques.",
    },
    {
      title: "Chocolate Art & Sculpting",
      desc: "Advanced chocolate tempering, sculptures and showpiece desserts.",
    },
    {
      title: "Signature Dessert Creation",
      desc: "Create your own bakery menu with unique signature desserts.",
    },
    {
      title: "Professional Bakery Setup",
      desc: "Learn costing, packaging, branding and starting your own bakery business.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div>
            ...
            <p className="text-lg text-[#666] leading-8 mb-8 max-w-xl">
              ...
              Professional techniques: plated desserts, chocolate tempering, advanced viennoiserie, professional finishing and quality control.
