  ...
  const learnItems = [
    {
      ...
      desc: "Learn essential kitchen safety rules and professional hygiene standards.",
    },
    {
      title: "Basic Doughs",
      desc: "Understand cake batter, cookie doughs and beginner baking techniques.",
    },
    {
      title: "Simple Pastries & Fillings",
      desc: "Practice beginner pastry preparation and delicious fillings.",
    },
    {
      title: "Basic Frosting & Piping",
      desc: "Learn frosting methods and simple cake decoration techniques.",
    },
    {
      title: "Hands-on Mini Projects",
      desc: "Build confidence with practical baking assignments and mini projects.",
    },
    {
      title: "Completion Certificate",
      desc: "Receive a certificate after successfully completing the course.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div>
            ...
            <p className="text-lg text-[#666] leading-8 mb-8 max-w-xl">
              ...
              Introductory course covering foundational baking skills:
              dough handling, beginner cakes, pastries and kitchen safety.
...
I want to enroll in Basic Baking Course.
